...
class OpenAIAgent(MaestroAgent):
    ...
    # Traces seem to show a default of 2048 being used, which is limiting when MCP tools are
    # returning a significant amount of text such as a list/description of tools
    ...
    def _process_agent_result(self, result: Optional[Any]) -> str:
        ...
        if final_output is not None:
            ...
            # TODO: Refine where output is printed
    ...
    async def _run_internal(self, prompt: str) -> str:
        ...
        try:
            ...
            async with mcp_stack:
                # Prepare model settings and agent arguments
                ...
                agent_kwargs: Dict[str, Any] = {
                    ...
                    "model_settings": model_settings_obj, # Pass ModelSettings object
                }
    ...
    async def _run_streaming_internal(self, prompt: str) -> str:
        ...
        try:
            ...
            async with mcp_stack:
                # Prepare model settings and agent arguments
                # TODO: Extend model parameters as needed (temperature, ....)
                model_settings_dict: Dict[str, Any] = {}
                if self.max_tokens is not None:
                    model_settings_dict["max_tokens"] = self.max_tokens
                model_settings_obj = ModelSettings(**model_settings_dict)
                ...
                # TODO: Refactor some stream handling into common routine across backends?
